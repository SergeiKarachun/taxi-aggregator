Feature: Driver Service
  ...
  Scenario: Creating a new driver with non-unique phone
    ...
    When A create request with phone "+375331234567" is passed to the add method
    Then The AlreadyExistsException should be thrown for phone "+375331234567"

  Scenario: Creating a new driver with unique data
    Given A driver with phone "+375331234567" doesn't exist
    When A create request with phone "+375331234567" is passed to the add method
    Then The response should contain created driver

  Scenario: Update driver by non-existing id
    Given A driver with id 1 doesn't exist
    When An update request with phone "+375331234567" for driver with id 1 is passed to the update method
    Then The NotFoundException with id 1 should be thrown

  Scenario: Update driver with unique data
    Given A driver with id 1 exists when phone "+375331234567" doesn't exist
    When An update request with phone "+375331234567" for driver with id 1 is passed to the update method
